...
RcppExport SEXP _wru_sample_me(SEXP last_nameSEXP, SEXP first_nameSEXP, SEXP mid_nameSEXP, SEXP geoSEXP, SEXP N_rgSEXP, SEXP M_rsSEXP, SEXP M_rfSEXP, SEXP M_rmSEXP, SEXP alphaSEXP, SEXP pi_sSEXP, SEXP pi_fSEXP, SEXP pi_mSEXP, SEXP pi_nrSEXP, SEXP which_namesSEXP, SEXP samplesSEXP, SEXP burninSEXP, SEXP me_nameSEXP, SEXP me_raceSEXP, SEXP race_initSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(sample_me(last_name, first_name, mid_name, geo, N_rg, M_rs, M_rf, M_rm, alpha, pi_s, pi_f, pi_m, pi_nr, which_names, samples, burnin, me_name, me_race, race_init, verbose));
