...
// sample_me
arma::umat sample_me(const arma::uvec& last_name, const arma::uvec& first_name, const arma::uvec& mid_name, const arma::uvec& geo, const arma::umat& N_rg, const arma::mat& alpha, const arma::mat& pi_s, const arma::mat& pi_f, const arma::mat& pi_m, const arma::mat& pi_nr, const arma::uword which_names, const arma::uword samples, const arma::uword burnin, const bool me_race, const arma::uvec& race_init, const bool verbose);
RcppExport SEXP _wru_sample_me(SEXP last_nameSEXP, SEXP first_nameSEXP, SEXP mid_nameSEXP, SEXP geoSEXP, SEXP N_rgSEXP, SEXP alphaSEXP, SEXP pi_sSEXP, SEXP pi_fSEXP, SEXP pi_mSEXP, SEXP pi_nrSEXP, SEXP which_namesSEXP, SEXP samplesSEXP, SEXP burninSEXP, SEXP me_raceSEXP, SEXP race_initSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(sample_me(last_name, first_name, mid_name, geo, N_rg, alpha, pi_s, pi_f, pi_m, pi_nr, which_names, samples, burnin, me_race, race_init, verbose));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_wru_sample_me", (DL_FUNC) &_wru_sample_me, 16},
    {NULL, NULL, 0}
};
