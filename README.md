...
The WRU prediction has the option of census.geo = "place" for using statistics based on Census Designated Places (CDP). To make such predictions, the input data (voter.file) needs to have a column named "place". Here is an example:
```r
data(voters)
...
#
# Or preload the census statistics to a census object and using it in prediction 
#
