...
#'
#' @param data_url URL root of the API, including the '?', 
#'  e.g., "http://api.census.gov/data/2010/sf1?".
#' @param key A required character object containing user's Census API key, 
#'  which can be requested at http://api.census.gov/data/key_signup.html.
#' @param vars A character vector of variables to get, 
#'  e.g., c("P0050003","P0050004","P0050005", "P0050006").
