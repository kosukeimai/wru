...
#'
#' @return Output will be data.frame of census geographic and race breakdown data, 
                                 ...
                                 retry = 0) 
{
  ...
  if (age == TRUE & sex == TRUE) {
    ...
    census$state <- state
    if (age == FALSE & sex == FALSE) {
      census$r_whi <- census$P005003
      census$r_bla <- census$P005004
      census$r_his <- census$P005010
      census$r_asi <- (census$P005006 + census$P005007)
      census$r_oth <- (census$P005005 + census$P005008 + census$P005009)
    }
    if (age == FALSE & sex == TRUE) {
