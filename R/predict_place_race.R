...
#'
#' \code{predict_place_race} makes probabilistic estimates of individual-level race/ethnicity.
#'
...
## Race Prediction Function
predict_place_race <- function(voter.file, 
  ...
  if (census.geo == "place") {
    ...
    voter.file <- census_place_helper(key = census.key, 
