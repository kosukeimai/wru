...
Compare row 9 (`Wantchekon`) with the standard-BISG output above: under standard BISG, the absent surname falls back on the population marginal (~33% White, ~19% Black, ~40% Hispanic). Under eBISG, the embedding model produces a name-specific prediction.
